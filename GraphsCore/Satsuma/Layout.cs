...
namespace Satsuma.Drawing
{
	...
	public sealed class ForceDirectedLayout
	{
		...
		public ForceDirectedLayout(IGraph graph, Func<Node, PointD> initialPositions = null, int randomSeed = 0)
		{
			Graph = graph;
        ...
        public void Initialize(Func<Node, PointD> initialPositions = null, int randomSeed = 0)
		{
