...
namespace Graphs
{
    public class GraphCanvas : GraphicsLayer.IPaintable
    {
        ...
        static readonly ARGB GridPenColor = new ARGB(30, 0, 0, 0);
        ...
        public GraphCanvas(Graph graph, Func<Choosability.Graph, Graph> layoutEngine = null, Func<string, Graph> secondaryConverter = null)
        {
